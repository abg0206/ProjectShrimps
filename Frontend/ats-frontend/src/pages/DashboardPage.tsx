...
export default function DashboardPage() {
  const [jobs, setJobs] = useState([
    { id: 1, title: 'Software Engineer', company: 'Google', status: 'Applied', date: '6/1/2026', body: 'We are looking for a Software Engineer to join our team for the 2027 summer.' },
    { id: 2, title: 'Frontend Developer', company: 'Meta', status: 'Interview', date: '6/3/2026', body: 'We are seeking a Frontend Developer with experience in Frontend development.' },
    { id: 3, title: 'React Developer', company: 'Amazon', status: 'Interested', date: '6/5/2026', body: 'Join our team to build Frontend Applications using React.' },
  ])
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
          {jobs.map((job) => (
            ...
            <div key={job.id} style={{ backgroundColor: '#E6CECB', borderRadius: '10px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', minHeight: '200px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: '#932C20' }}>
      ...
      {showModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ backgroundColor: '#E6CECB', borderRadius: '10px', padding: '24px', width: '400px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div>
              <label style={{ fontSize: '13px', color: '#3C1510', display: 'block', marginBottom: '4px' }}>Job Posting Body</label>
              <textarea
                value={newBody}
